...
if (!isset($_SESSION['role'])) {
    // If role isn't even set, we can't do anything reliable. Just let it be or set a default.
    $_SESSION['role'] = 'user';
}

if ($_SESSION['role'] === 'user') {
    if (!isset($_SESSION['full_name']) || !isset($_SESSION['hospital_id']) || !isset($_SESSION['profile_picture']) || !isset($_SESSION['location_id'])) {
...
// Redirect to onboarding if hospital_id is not set (ONLY for users)
if ($_SESSION['role'] === 'user' && (!isset($_SESSION['hospital_id']) || empty($_SESSION['hospital_id']))) {
