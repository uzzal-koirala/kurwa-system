  ...
  if (!empty($otp_input)) {
    ...
    if ($result->num_rows > 0) {
      ...
      $message = "<p class='text-green-600 text-sm font-medium text-center mb-3'>
                    OTP verified successfully! Redirecting to onboard...
                  </p>";
...
if (isset($_POST['resend'])) {
  ...
  // Fetch phone number to send SMS
  ...
  if ($result->num_rows > 0) {
      ...
      $phone = $user['phone'];
      if (!empty($phone)) {
          $sms_message = "Dear User, your Kurwa System verification code is: $new_otp. Please do not share this code with anyone for security reasons.";
          send_sms($phone, $sms_message);
      }
  }

  $message = "<p class='text-green-600 text-sm font-medium text-center mb-3'>
                A new OTP has been generated and sent to your phone!
              </p>";
}
?>
