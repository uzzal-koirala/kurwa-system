            ...
            <div class="content-card">
                <div class="card-header">
                    ...
                    <div style="display: flex; gap: 15px; font-size: 11px; font-weight: 700;">
                        ...
                        <span style="cursor: pointer; color: #00bcc2;">WEEK</span>
                    </div>
                </div>
                <div style="display: flex; gap: 30px; align-items: stretch;">
                    ...
                    <div style="width: 200px; background: #00bcc2; border-radius: 12px; padding: 30px 20px; color: white; text-align: center; display: flex; flex-direction: column; justify-content: center;">
...
<script>
    ...
    clinicGradient.addColorStop(0, 'rgba(0, 188, 194, 0.2)');
    clinicGradient.addColorStop(1, 'rgba(0, 188, 194, 0)');
    ...
    new Chart(document.getElementById('incomeSpark'), {
        type: 'line',
        data: { labels: [1,2,3,4,5], datasets: [{ data: [15,35,22,45,28], borderColor: '#00bcc2', borderWidth: 2, pointRadius: 0, fill: false, tension: 0.4 }] },
